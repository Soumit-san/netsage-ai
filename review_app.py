...
st.set_page_config(page_title="NetSage AI - Review", layout="wide")
...
st.title("NetSage AI - Human Review Workflow")
...
if df_unreviewed.empty:
    ...
    with col2:
        ...
        st.markdown("Is the AI diagnosis correct based on the evidence?")
